...
userDashboardRouter.get('/overview', userAuthenticate, getUserDashboardOverview);
userDashboardRouter.get("/investments", userAuthenticate, getUserInvestments);
userDashboardRouter.get('/transactions', userAuthenticate, getUserTransactionHistory);
